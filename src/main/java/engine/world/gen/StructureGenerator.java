...
public class StructureGenerator {
    ...
    public static Map<Vector3s, BlockType> generateOakTree(int x, int y, int z) {
        ...
        for (int[] corner : corners) {
            ...
            placeBlockWithChance(blocks, x + corner[0], y + 3, z + corner[1], oakLeaves, 0.7);
        }
